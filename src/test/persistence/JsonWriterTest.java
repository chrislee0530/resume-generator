...
public class JsonWriterTest extends JsonTest {
    ...
    void testWriterGeneralResume() {
        try {
            Resume resume = new Resume();
            resume.setProfile(
                    new Profile("Chris", "7781234567", "cpsc210@gmail.com", "Vancouver, BC", "Software Engineer"));
            resume.addExperience(new Experience("Software Engineer", "Google", "Seattle", "2020", "6", "2023", "12",
                    "Software Engineer"));
            ...
            checkProfile("Chris", "7781234567", "cpsc210@gmail.com", "Vancouver, BC", "Software Engineer",
                    resume.getProfile());
